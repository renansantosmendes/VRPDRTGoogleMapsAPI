...
//        this.duration = new AdjacenciesDAO(this.adjacenciesTable, this.nodesInstanceName).getDurationBetweenNodes(this.numberOfNodes);
//        this.distance = new AdjacenciesDAO(this.adjacenciesTable, this.nodesInstanceName).getDistanceBetweenNodes(this.numberOfNodes);
    }
